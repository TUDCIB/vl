...
class ZoneObject:
    ...
    #purpose of this function:  Changes the climate data location
    #submitted variables:       string object 
    #return values:             none
    def add_ClimateLocation(self, climateLocation):
        #changes the climate data set
        self.__weatherDataSetName = climateLocation
        
    #purpose of this function:  Access to current climate location
    #submitted variables:       none 
    #return values:             string of climate location
    def return_ClimateLocation(self):
        #changes the climate data set
        return self.__weatherDataSetName
    ...
    def add_idealHeatingModel(self, maxPower, mode, controlType, ScheduleObject):
        print("ideal heating:")
        if( mode != "None" ):
            print("add ideal heating really.")
            ...
            for consObject in self.constructions:
                ...
                for layer in consObject.return_listOfLayers():
                    ...
                    if (len(self.materials) == 0):
                        ...
                        materialList.add(layer.mat.return_name())
                    
                    else:
                        #loop over all materials in member list to check properties
                        if (not (materialList.__contains__(layer.mat.return_name()))):
